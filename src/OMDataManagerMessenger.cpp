 ...
 _DataManager(Constr)
{
    ...
    this->_dataFilterOutProcessCmd = new G4UIcmdWithAString("/data_acquisition/outProcess_filter",this);
    ...
    this->_dataFilterOutVolumeCmd = new G4UIcmdWithAString("/data_acquisition/outVolume_filter",this);
    ...
    this->_dataFilterGlassCmd = new G4UIcmdWithABool("/data_acquisition/glass_filter",this);
    ...
    this->_dataFilterPhotonsCmd = new G4UIcmdWithABool("/data_acquisition/photons_filter",this);
